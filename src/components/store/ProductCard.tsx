  ...
  return (
    ...
    >
      <div className="relative aspect-square bg-secondary overflow-hidden p-6 md:p-0">
        ...
        {product.isBogo && (
          <span className="absolute top-2 right-2 bg-primary text-primary-foreground text-[10px] md:text-xs font-bold px-1.5 py-0.5 rounded z-10 flex items-center gap-1">
