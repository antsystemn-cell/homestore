          ...
          {stories.map((s, i) => {
            ...
            return (
              <button
                key={s.id}
                onClick={() => openStory(i)}
                className="group relative flex-shrink-0 w-[180px] md:w-[220px] aspect-[9/16] overflow-hidden bg-muted rounded-lg hover:shadow-xl transition-all duration-300 active:scale-[0.98] snap-start"
