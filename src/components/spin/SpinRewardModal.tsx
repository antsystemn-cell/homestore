        ...
        <div className="p-6 space-y-4">
          ...
          {isFreeGift && (
            <>
              <div className="border-2 border-dashed border-red-500 rounded-xl p-4 text-center bg-red-50 dark:bg-red-950/20">
                <p className="text-xs text-muted-foreground mb-1">Сүүүүүүпэр бэлэг</p>
                {result.coupon_code && (
          ...
          {isExtra && (
            <div className="text-center py-2">
              <p className="text-base">Танд <span className="font-bold text-primary">дахин эргүүлэх эрх</span> нэмэгдлээ.</p>
