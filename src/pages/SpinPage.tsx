...
export default function SpinWheelPage() {
  ...
  return (
    <div className="min-h-[50vh] bg-gradient-to-br from-[#1a0b2e] via-[#0f0a1f] to-[#1a0b2e] flex items-center justify-center p-4 sm:p-6 relative rounded-2xl mx-auto max-w-lg my-4">
      {/* Ambient glow */}
      ...
      <button
        onClick={() => navigate(-1)}
        className="fixed top-4 right-4 z-50 w-10 h-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white/80 hover:text-white hover:bg-white/20 transition-colors"
        aria-label="Хаах"
      >
        <X className="w-5 h-5" />
      </button>
