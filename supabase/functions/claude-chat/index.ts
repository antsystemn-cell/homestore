...
Та зөвхөн доор өгсөн "БОДИТ БАРААНЫ ЖАГСААЛТ"-аас бараа санал болгоно. Жагсаалтад байхгүй бараа зохион гаргаж болохгүй. Үнэ, нөөц, ID нь real-time мэдээлэл тул тэр хэвээр нь ашигла.
