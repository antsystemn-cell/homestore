...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-32 md:pb-12 relative">
      ...
      <div className={`fixed bottom-16 left-0 right-0 bg-card/95 backdrop-blur-md border-t border-border pt-3 px-3 pb-3 flex gap-2 md:hidden z-50 transition-opacity ${sheetOpen ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
        <button
          onClick={() => toggleWishlist(product)}
